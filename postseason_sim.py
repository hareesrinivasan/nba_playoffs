...
class SimPlayoffs:
    def __init__(self, east1, east2, east3, east4, east5, east6, east7, east8,
    ...
    def _first_round(self):
        east1_8 = SimSeries(self.east1, self.east8, self.year)
        east1_8.sim_series()
        self.east1_8_winner = east1_8.winner

        east2_7 = SimSeries(self.east2, self.east7, self.year)
        east2_7.sim_series()
        self.east2_7_winner = east2_7.winner

        east3_6 = SimSeries(self.east3, self.east6, self.year)
        east3_6.sim_series()
        self.east3_6_winner = east3_6.winner

        east4_5 = SimSeries(self.east4, self.east5, self.year)
        east4_5.sim_series()
        self.east4_5_winner = east4_5.winner

        west1_8 = SimSeries(self.west1, self.west8, self.year)
        west1_8.sim_series()
        self.west1_8_winner = west1_8.winner

        west2_7 = SimSeries(self.west2, self.west7, self.year)
        west2_7.sim_series()
        self.west2_7_winner = west2_7.winner

        west3_6 = SimSeries(self.west3, self.west6, self.year)
        west3_6.sim_series()
        self.west3_6_winner = west3_6.winner

        west4_5 = SimSeries(self.west4, self.west5, self.year)
        west4_5.sim_series()
...
if __name__=="__main__":
    s = SimSeries(team1="Toronto Raptors", team2="Orlando Magic", year=2019)
    d = s.sim_series()
    print("done")